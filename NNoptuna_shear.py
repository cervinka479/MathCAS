...
# Clear the NN_shear_training_log folder
log_dir = 'NN_shear_training_log'
...
def objective(trial, task='class'):
    ...
    for epoch in range(num_epochs):  # Use sampled number of epochs for training
        ...
        if epoch_val_loss < best_val_loss:
            ...
            torch.save(model.state_dict(), f'NN_shear_training_log/trial{trial.number}_best_model.pth')
    ...
    df_metrics.to_csv(f'NN_shear_training_log/trial{trial_number}.csv', index=False)
