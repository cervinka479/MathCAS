...
# Normalize the input tensors (matrix A)
input_scaler = MinMaxScaler()
normalized_input_tensors = input_scaler.fit_transform(input_tensors)

# Normalize the output tensors (S, Ω, shear tensor)
...
train_input, test_input, train_output, test_output = train_test_split(
    normalized_input_tensors, normalized_output_tensors, test_size=0.2, random_state=42
)
