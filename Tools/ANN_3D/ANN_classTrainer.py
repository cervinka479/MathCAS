...
modelArchitecture = nnArch(io=[9,1], hl=[160,128,96])
...
predictions, accuracy = nnPredict(loadModel="classificator_double_VL{7.373e-02}_942571.pth", testDataset=absmaxScaledData,model=modelArchitecture,output=False)
