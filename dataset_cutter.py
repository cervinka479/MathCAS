...
df = pd.read_csv(r"deleteme\dataset3D_10M_training_nstep180.csv", usecols=columns, nrows=50000)

# Write these selected columns to a new CSV file
df.to_csv(r"deleteme\dataset3D_50K_training_sampled.csv", index=False)